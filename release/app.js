...
var _ionicons = __webpack_require__(12);
...
var Icon = function Icon(props) {
    ...
    return React.createElement(
        'doric-icon',
        _extends({ 'class': className }, passThrough),
        icons[icon]
    );
};
Icon.icons = icons;
...
var _ssjs = __webpack_require__(8);
...
var _collapse = __webpack_require__(13);
...
_style2.default.add({
    ...
    "doric-button[data-touch-active]:not([disabled='true'])::after": _extends({}, _util2.default.background.after.colorize(_theme2.default.toggle.hl)),
    ...
    this.render = function () {
        ...
        return React.createElement(
            ...
            React.createElement(
                'doric-collapse-title',
                null,
                React.createElement(_customListeners2.default, { listeners: { onTap: _this2.toggle } }),
                title
            ),
            React.createElement(
                'doric-collapse-content',
