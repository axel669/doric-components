...
var _immutableUpdateValues = require('immutable-update-values');

var _immutableUpdateValues2 = _interopRequireDefault(_immutableUpdateValues);
...
console.log(_immutableUpdateValues2.default);
...
var theme = (0, _immutableUpdateValues2.default)({}, Object.keys(themeValues).reduce(function (theme, key) {
