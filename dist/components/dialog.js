...
function AlertDialog(props) {
  ...
  return React.createElement(Panel, null, React.createElement(Title, {
    title: props.title
  }), React.createElement("div", null, props.message), React.createElement(Panel.actions, null, React.createElement(Button, {
    text: "OK",
    block: true,
    primary: true,
    flat: true,
...
function PromptDialog(props) {
  ...
  useMounts(() => inputRef.current.focus());
  return React.createElement(Panel, null, React.createElement(Title, {
    title: props.title
    ...
    onChange: update,
    ref: inputRef
  })), React.createElement(Panel.actions, null, React.createElement(Button, {
    text: "Cancel",
    block: true,
    danger: true,
    flat: true,
