...
_style.default.add({
  "@font-face": {
    fontFamily: "\"Ionic\"",
    src: "url(\"".concat(ionicIconsURL, "\") format(\"woff\")"),
    fontWeight: "normal",
    fontStyle: "normal"
  },
  "doric-icon": {
...
var DoricIcon = function DoricIcon(props) {
  ...
  return _react.default.createElement("doric-icon", _extends({
    class: className
  }, passThrough, {
    "data-icon-name": icon
  }), icons[icon]);
